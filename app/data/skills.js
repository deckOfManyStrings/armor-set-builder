export const skills = [
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Attack +10 while active." },
        { level: 2, effect: "Attack +15 while active. Moderately extends effect time." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Attacks that hit weak points gain affinity +5%, with an extra 3% on wounds." },
        { level: 2, effect: "Attacks that hit weak points gain affinity +10%, with an extra 5% on wounds." },
        { level: 3, effect: "Attacks that hit weak points gain affinity +15%, with an extra 10% on wounds." },
        { level: 4, effect: "Attacks that hit weak points have 20% increased affinity, with an extra 15% on wounds." },
        { level: 5, effect: "Attacks that hit weak points have 30% increased affinity, with an extra 20% on wounds." }
      ]
    },
    {
      id: "maximum_might",
      ...
      type: "Equipment Skill",
      maxLevel: 3,
      description: "Increases affinity if stamina is kept full for a period of time.",
      effects: [
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Slightly increases abnormal status effects when landing critical hits." },
        { level: 2, effect: "Increases abnormal status effects when landing critical hits." },
        { level: 3, effect: "Greatly increases abnormal status effects when landing critical hits." }
      ]
    },
    {
      id: "charge_master",
      ...
      effects: [
        { level: 1, effect: "Slightly increases elemental damage and status buildup for charged attacks." },
        { level: 2, effect: "Increases elemental damage and status buildup for charged attacks." },
        { level: 3, effect: "Greatly increases elemental damage and status buildup for charged attacks." }
      ]
    },
    {
      id: "convert_element",
      ...
      effects: [
        { level: 1, effect: "While active, deals extra dragon damage after dealing enough elemental damage. Slightly increases dragon attack." },
        { level: 2, effect: "Increases additional dragon damage and increases dragon attack." },
        { level: 3, effect: "Further increases additional dragon damage and greatly increases dragon attack" }
      ]
    },
    {
      id: "handicraft",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Grants no sharpness loss for 30 seconds after activation." },
        { level: 2, effect: "Grants no sharpness loss for 60 seconds after activation." },
        { level: 3, effect: "Grants no sharpness loss for 90 seconds after activation." }
      ]
    },
    {
      id: "minds_eye",
      ...
      effects: [
        { level: 1, effect: "50% chance of your attacks not being deflected, +10% damage to hard targets." },
        { level: 2, effect: "100% chance of your attacks not being deflected, +15% damage to hard targets." },
        { level: 3, effect: "100% chance of your attacks not being deflected, +30% damage to hard targets." }
      ]
    },
    {
      id: "masters_touch",
      ...
      effects: [
        { level: 1, effect: "Grants an 80% chance of no sharpness loss while active." }
      ]
    },
    {
      id: "bludgeoner",
      ...
      effects: [
        { level: 1, effect: "5% attack power when your sharpness gauge is yellow or lower." },
        { level: 2, effect: "10% attack power when your sharpness gauge is yellow or lower." },
        { level: 3, effect: "10% attack power when your sharpness gauge is green or lower." }
      ]
    },
    {
      id: "normal_shots",
      ...
      effects: [
        { level: 1, effect: "Slightly increases the power of specified ammo and arrows." }
      ]
    },
    {
      id: "piercing_shots",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Rapid fire damage +5%" }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Moderately increases the power of specified ammo and arrows." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Lets you use poison coatings." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Lets you use paralysis coatings." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Lets you use sleep coatings." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Lets you use blast coatings." }
      ]
    },
    {
      id: "opening_shot",
      ...
      effects: [
        { level: 1, effect: "Moderately increases bowgun reload speed and attack power of ammo when certain conditions are met." },
        { level: 2, effect: "Increases bowgun reload speed and attack power of ammo when certain conditions are met." },
        { level: 3, effect: "Greatly increases bowgun reload speed and attack power of ammo when certain conditions are met." }
      ]
    },
    {
      id: "tetrad_shot",
      ...
      effects: [
        { level: 1, effect: "Slightly increases the attack power and affinity of ammo after certain conditions are met." },
        { level: 2, effect: "Moderately increases attack power and affinity of ammo after certain conditions are met." },
        { level: 3, effect: "Increases the attack power and affinity of ammo after certain conditions are met." }
      ]
    },
    {
      id: "defense_boost",
      ...
      effects: [
        ...
        { level: 4, effect: "Defense +5% Bonus: +20 All elemental resistances +3" },
        { level: 5, effect: "Defense +8% Bonus: +20 All elemental resistances +3" },
        { level: 6, effect: "Defense +8% Bonus: +35 All elemental resistances +5" },
        { level: 7, effect: "Defense +10% Bonus: +35 All elemental resistances +5" }
      ]
    },
    {
      id: "divine_blessing",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Reduces the number of times you take poison damage." },
        { level: 2, effect: "Greatly reduces the number of times you take poison damage." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Reduces the duration of all elemental blights by 50%." },
        { level: 2, effect: "Reduces the duration of all elemental blights by 75%." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Allows you to quickly recover from webbed status or frostblight." },
        { level: 2, effect: "Allows you to very quickly recover from webbed status or frostblight." },
    ...
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "Greatly delays blastblight and greatly reduces blast damage." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Doubles the speed at which you heal recoverable damage." },
        { level: 2, effect: "Triples the speed at which you heal recoverable damage." },
        { level: 3, effect: "Quadruples the speed at which you heal recoverable damage." }
      ]
    },
    {
      id: "survival_expert",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Extends the time until your stamina cap reduces by 50%." },
        { level: 2, effect: "Extends the time until your stamina cap reduces by 100%." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "While active, affinity +10% and reduces stamina depletion by 30%." },
        { level: 2, effect: "While active, affinity +20% and reduces stamina depletion by 30%." },
        { level: 3, effect: "While active, affinity +30% and reduces stamina depletion by 50%." },
        { level: 4, effect: "While active, affinity +40% and reduces stamina depletion by 50%." },
        { level: 5, effect: "While active, affinity +50% and reduces stamina depletion by 50%." }
      ]
    },
    {
      id: "burst",
      ...
      effects: [
        { level: 1, effect: "On first hit, gain a small temporary attack and element boost, replaced by a larger boost after the fifth hit." },
        ...
        { level: 4, effect: "Hit 5 successive times for an even bigger stat boost." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Makes it ever so slightly easier to inflict wounds. Also deals additional non-elemental damage." },
        { level: 2, effect: "Makes it moderately easier to inflict wounds. Also deals slightly more additional non-elemental damage." },
        { level: 3, effect: "Makes it easier to inflict wounds. Also deals moderately more additional non-elemental damage." },
        { level: 4, effect: "Makes it much easier to inflict wounds. Also deals more additional non-elemental damage." },
        { level: 5, effect: "Makes it significantly easier to inflict wounds. Also deals much more additional non-elemental damage." }
      ]
    },
    {
      id: "heroics",
      ...
      effects: [
        ...
        { level: 5, effect: "Attack +30% and defense-increasing effects are negated while active." }
      ]
    },
    {
      id: "palico_rally",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Slightly increases gauge fill rate and reduces charge times by 5%." },
        { level: 2, effect: "Moderately increases gauge fill rate and reduces charge times by 10%." },
        { level: 3, effect: "Increases gauge fill rate and reduces charge times by 15%." }
      ]
    },
    {
      id: "power_prolonger",
      ...
      effects: [
        { level: 1, effect: "Moderately boosts the duration weapons are powered up." },
        { level: 2, effect: "Boosts the duration weapons are powered up." },
        { level: 3, effect: "Greatly boosts the duration weapons are powered up." }
      ]
    },
    {
      id: "punishing_draw",
      ...
      effects: [
        { level: 1, effect: "Draw attacks deal a small amount of stun damage and gain attack +3." },
        { level: 2, effect: "Draw attacks deal a medium amount of stun damage and gain attack +5." },
        { level: 3, effect: "Draw attacks deal a large amount of stun damage and gain attack +7." }
      ]
    },
    {
      id: "slugger",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Moderately increases each attack and Wyvern's Fire firing speed. Shelling fire attack +30." },
        { level: 2, effect: "Increases each attack and Wyvern's Fire firing speed. Shelling fire attack +60." },
        { level: 3, effect: "Greatly increases each attack and Wyvern's Fire firing speed. Shelling fire attack +90." }
      ]
    },
    {
      id: "rapid_morph",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Increases part damage and damage dealt when conditions are met by 10%." },
        { level: 2, effect: "Increases part damage and damage dealt when conditions are met by 20%." },
        { level: 3, effect: "Increases part damage and damage dealt when conditions are met by 30%." }
      ]
    },
    {
      id: "foray",
      ...
      effects: [
        { level: 1, effect: "Attack +6 against large monsters affected by poison or paralysis." },
        { level: 2, effect: "Attack +8 and affinity +5% against large monsters affected by poison or paralysis." },
        { level: 3, effect: "Attack +10 and affinity +10% against large monsters affected by poison or paralysis." },
        { level: 4, effect: "Attack +12 and affinity +15% against large monsters affected by poison or paralysis." },
        { level: 5, effect: "Attack +15 and affinity +20% against large monsters affected by poison or paralysis." }
      ]
    },
    {
      id: "coalescence",
      ...
      effects: [
        { level: 1, effect: "When active, grants a slight increase to elemental damage and status buildup." },
        { level: 2, effect: "When active, grants an increase to elemental damage and status buildup." },
        { level: 3, effect: "When active, grants a large increase to elemental damage and status buildup." }
      ]
    },
    {
      id: "ambush",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Slightly increases recovery rate after contracting the Frenzy. Affinity +3% if cured." },
        { level: 2, effect: "Increases recovery rate after contracting the Frenzy. Affinity +6% if cured." },
        { level: 3, effect: "Greatly increases recovery rate after contracting the Frenzy. Affinity +15% if cured." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "While active, slightly increases elemental attack, and resistance to element taken at activation by 4." },
        { level: 2, effect: "While active, moderately increases elemental attack, and resistance to element taken at activation by 6." },
        { level: 3, effect: "While active, increases elemental attack, and resistance to element taken at activation by 8." }
      ]
    },
    {
      id: "horn_maestro",
      ...
      effects: [
        { level: 1, effect: "Extends Melody Effect duration and increases the chance of larger heals from healing melodies." },
        { level: 2, effect: "Greatly increases the effect duration of hunting horn melodies." }
      ]
    },
    {
      id: "charge_up",
      ...
      effects: [
        { level: 1, effect: "Activates skill effect." }
      ]
    },
    {
      id: "airborne",
      ...
      effects: [
        { level: 1, effect: "Jumping attack power +10%" }
      ]
    },
    {
      id: "self_improvement",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Extends the duration of your poison's effect by 20%." }
      ]
    },
    {
      id: "guard",
      ...
      effects: [
        { level: 1, effect: "Slightly decreases the impact of attacks and reduces stamina depletion by 15%." },
        { level: 2, effect: "Decreases the impact of attacks and reduces stamina depletion by 30%." },
        { level: 3, effect: "Greatly decreases the impact of attacks and reduces stamina depletion by 50%." }
      ]
    },
    {
      id: "evade_window",
    ...
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "Nullifies weak monster roars and reduces the effects of strong monster roars." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Negates minor wind pressure and halves the effects of major wind pressure." },
        { level: 2, effect: "Negates minor and major wind pressure and halves the effects of dragon wind pressure." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Nullifies very minor ground tremors and halves effects of minor ground tremors." },
        { level: 2, effect: "Nullifies up to minor ground tremors and greatly reduces the effects of major ground tremors." },
    ...
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "Prevents knockbacks. Tripping is reduced to a knockback instead." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Discourages monsters from engaging you even if you've been spotted." },
        { level: 2, effect: "Highly discourages monsters from engaging you even if you've been spotted." },
        { level: 3, effect: "Prevents monsters from engaging you even if you've been spotted." }
      ]
    },
    {
      id: "speed_eating",
    ...
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "Increases shell/phial reloading speed. Gunlance loading capacity +1. Charge blade charges 5 phials on yellow gauge." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Negates the effects of muddy streams, and prevents you from being slowed down in water or oilsilt." },
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Enables skill use." }
      ]
    },
    {
      id: "jump_master",
      ...
      effects: [
        { level: 1, effect: "Negates knockback during jumps." }
      ]
    },
    {
      id: "cliffhanger",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Items affect nearby allies with 33% of their efficacy." },
        { level: 2, effect: "Items affect nearby allies in a wider radius with 33% of their efficacy." },
        { level: 3, effect: "Items affect nearby allies in a wider radius with 66% of their efficacy." },
        { level: 4, effect: "Items affect nearby allies in a much wider radius with 66% of their efficacy." },
        { level: 5, effect: "Items affect nearby allies in a much wider radius with full efficacy." }
      ]
    },
    {
      id: "tool_specialist",
    ...
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "Additionally lets you digest nitroshrooms and parashrooms." },
        { level: 3, effect: "Additionally lets you digest mandragoras, devil's blight, and exciteshrooms." }
      ]
    },
    {
      id: "item_prolonger",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Improves the effectiveness of flash attacks and items." }
      ]
    },
    {
      id: "botanist",
      ...
      effects: [
        ...
        { level: 2, effect: "Additionally adds one extra consumable fruit, nut, or seed item per gather." },
        { level: 3, effect: "Additionally adds one extra consumable insect item per gather." },
        { level: 4, effect: "Additionally adds one extra consumable mushroom item per gather." }
      ]
    },
    {
      id: "geologist",
      ...
      effects: [
        ...
        { level: 2, effect: "Additionally adds one extra item when gathering special items." },
        { level: 3, effect: "Additionally adds one extra item when gathering from mining outcrops." }
      ]
    },
    {
      id: "entomologist",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Improves fishing, grilling, and transporting abilities." }
      ]
    },
    {
      id: "honey_hunter",
      ...
      effects: [
        { level: 1, effect: "Increases the amount of honey you gain from gathering points." }
      ]
    },
    {
      id: "fleetfoot",
      ...
      effects: [
        { level: 1, effect: "Increases movement speed while crouching, and makes it easier to escape large monsters' detection." }
      ]
    },
    {
      id: "master_mounter",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Makes it easier to mount monsters and to wound them once mounted.",
      effects: [
        { level: 1, effect: "Makes it easier to mount monsters and to wound them once mounted." }
      ]
    },
    {
      id: "adrenaline",
      ...
      effects: [
        { level: 1, effect: "Temporarily reduces stamina depletion when health is at 40% or lower." }
      ]
    },
    {
      id: "hunter_gatherer",
      ...
      effects: [
        { level: 1, effect: "Increases gathering speed, and prevents knock back when gathering or carving." }
      ]
    },
    {
      id: "affinity_sliding",
      ...
      effects: [
        { level: 1, effect: "Increases your affinity temporarily when sliding on terrain." }
      ]
    },
    {
      id: "fortify",
      ...
      effects: [
        { level: 1, effect: "Increases attack and defense after fainting during a quest. (Can be used twice.)" }
      ]
    },
    {
      id: "diversion",
      ...
      effects: [
        { level: 1, effect: "Increases the attention drawn to you when attacking a monster." }
      ]
    },
    {
      id: "inspiration",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Temporarily increases attack power when using effects like Melody Effects that affect companions in range.",
      effects: [
        { level: 1, effect: "Temporarily increases attack power when using effects like Melody Effects that affect companions in range." }
      ]
    },
    {
      id: "resuscitate",
    ...
    },
    {
      ...
      effects: [
        { level: 1, effect: "Increases recovery speed of stamina and red gauge when near Wylkrystals." }
      ]
    },
    {
      id: "ward_of_wyveria",
      ...
      effects: [
        { level: 1, effect: "Reduces elemental and unique damage while in the Ruins of Wyveria." }
      ]
    },
    {
      id: "foragers_luck",
      ...
      effects: [
        { level: 1, effect: "Increases the chance of finding rare gathering points." }
      ]
    },
    {
      id: "powerhouse_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Temporarily grants attack +10 after a successful Power Clash or Offset attack.",
      effects: [
        { level: 1, effect: "Temporarily grants attack +10 after a successful Power Clash or Offset attack." }
      ]
    },
    {
      id: "scorcher_i",
      ...
      effects: [
        { level: 1, effect: "Chance to deal additional fire damage after landing an attack." }
      ]
    },
    {
      id: "second_wind_i",
      ...
      effects: [
        { level: 1, effect: "Grants an additional Stamina Gauge." }
      ]
    },
    {
      id: "flawless_armor_i",
      ...
      effects: [
        { level: 1, effect: "Reduces the damage you take by 5% when your health is full." }
      ]
    },
    {
      id: "war_cry_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Using the To Victory! gesture moderately increases attack temporarily to nearby allies. Greatly effects Palicoes and Support Hunters.",
      effects: [
        { level: 1, effect: "Using the To Victory! gesture moderately increases attack temporarily to nearby allies. Greatly effects Palicoes and Support Hunters." }
      ]
    },
    {
      id: "burst_boost_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Extends the duration of the Burst skill and grants attack +3 while Burst is active.",
      effects: [
        { level: 1, effect: "Extends the duration of the Burst skill and grants attack +3 while Burst is active." }
      ]
    },
    {
      id: "protein_fiend_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Temporarily grants attack +15 after eating items such as well-done steak.",
      effects: [
        { level: 1, effect: "Temporarily grants attack +15 after eating items such as well-done steak." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Increases defense temporarily when using a specialized tool." }
      ]
    },
    {
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Moderately extends the activation time of the Latent Power skill.",
      effects: [
        { level: 1, effect: "Moderately extends the activation time of the Latent Power skill." }
      ]
    },
    {
      id: "bad_blood_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Deals moderate additional damage while the Resentment skill is active.",
      effects: [
        { level: 1, effect: "Deals moderate additional damage while the Resentment skill is active." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Increases attack after recovering from webbed status, frostblight, being pinned, or a Power Clash." }
      ]
    },
    {
      id: "black_eclipse_i",
      ...
      effects: [
        { level: 1, effect: "Infects you with Frenzy when against large monsters." }
      ]
    },
    {
      id: "decimator_i",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Restores a moderate amount of health when destroying a wound on a large monster.",
      effects: [
        { level: 1, effect: "Restores a moderate amount of health when destroying a wound on a large monster." }
      ]
    },
    {
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Regenerates a small amount of your health as you continually attack a monster. Recovery varies by weapon.",
      effects: [
        { level: 1, effect: "Regenerates a small amount of your health as you continually attack a monster. Recovery varies by weapon." }
      ]
    },
    {
      id: "powerhouse_ii",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Temporarily grants attack +25 after a successful Power Clash or Offset attack.",
      effects: [
        { level: 1, effect: "Temporarily grants attack +25 after a successful Power Clash or Offset attack." }
      ]
    },
    {
      id: "scorcher_ii",
      ...
      effects: [
        { level: 1, effect: "Increases additional fire damage after landing an attack." }
      ]
    },
    {
      id: "second_wind_ii",
      ...
      effects: [
        { level: 1, effect: "Grants an additional long Stamina Gauge." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Reduces the damage you take by 10% when your health is full." }
      ]
    },
    {
      id: "war_cry_ii",
      ...
      effects: [
        { level: 1, effect: "Using the To Victory! gesture increases attack temporarily to nearby allies. Greatly effects Palicoes and Support Hunters." }
      ]
    },
    {
      id: "burst_boost_ii",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Further extends the duration of the Burst skill and grants attack +10 while Burst is active.",
      effects: [
        { level: 1, effect: "Further extends the duration of the Burst skill and grants attack +10 while Burst is active." }
      ]
    },
    {
      id: "protein_fiend_ii",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Temporarily grants attack +25 after eating items such as well-done steak.",
      effects: [
        { level: 1, effect: "Temporarily grants attack +25 after eating items such as well-done steak." }
      ]
    },
    {
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Greatly increases defense and resistance temporarily when using a specialized tool.",
      effects: [
        { level: 1, effect: "Greatly increases defense and resistance temporarily when using a specialized tool." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Extends the activation time of the Latent Power skill." }
      ]
    },
    {
      id: "bad_blood_ii",
      ...
      effects: [
        { level: 1, effect: "Deals additional damage while the Resentment skill is active." }
      ]
    },
    {
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Greatly increases attack after recovering from webbed status, frostblight, being pinned, or a Power Clash.",
      effects: [
        { level: 1, effect: "Greatly increases attack after recovering from webbed status, frostblight, being pinned, or a Power Clash." }
      ]
    },
    {
      id: "black_eclipse_ii",
      ...
      type: "Equipment Skill",
      maxLevel: 1,
      description: "Infects you with Frenzy and raises attack when against large monsters. Attack power increases upon recovery.",
      effects: [
        { level: 1, effect: "Infects you with Frenzy and raises attack when against large monsters. Attack power increases upon recovery." }
      ]
    },
    {
      id: "decimator_ii",
      ...
      effects: [
        { level: 1, effect: "Restores health when destroying a wound on a large monster." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Regenerates your health as you continually attack a monster. Recovery varies by weapon." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "Lets you use exhaust coatings." }
      ]
    },
    {
      id: "neopteron_alert",
      ...
      description: "Increases the amount of honey you gain from gathering points.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Honey Hunter" }
      ]
    },
    {
      ...
      description: "Increases movement speed while crouching, and makes it easier to escape large monsters' detection.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Fleetfoot" }
      ]
    },
    {
      id: "scaling_prowess",
      ...
      description: "Makes it easier to mount monsters and to wound them once mounted.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Master Mounter" }
      ]
    },
    {
      id: "scale_layering",
      ...
      description: "Temporarily reduces stamina depletion when health is at 40% or lower.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Adrenaline" }
      ]
    },
    {
      ...
      description: "Increases gathering speed, and prevents knock back when gathering or carving.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Hunter Gatherer" }
      ]
    },
    {
      ...
      description: "Increases your affinity temporarily when sliding on terrain.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Affinity Sliding" }
      ]
    },
    {
      id: "fortifying_pelt",
      ...
      description: "Increases attack and defense after fainting during a quest. (Can be used twice.)",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Fortify" }
      ]
    },
    {
      id: "alluring_pelt",
      ...
      description: "Increases the attention drawn to you when attacking a monster.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Diversion" }
      ]
    },
    {
      id: "lords_favor",
      ...
      description: "Temporarily increases attack power when using effects like Melody Effects that affect companions in range.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Inspiration" }
      ]
    },
    {
      id: "lords_fury",
      ...
      description: "Increases attack when inflicted with ailments.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Resuscitate" }
      ]
    },
    {
      id: "guardians_pulse",
      ...
      description: "Increases recovery speed of stamina and red gauge when near Wylkrystals.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Wylk Burst" }
      ]
    },
    {
      ...
      description: "Reduces elemental and unique damage while in the Ruins of Wyveria.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Ward of Wyveria" }
      ]
    },
    {
      id: "imparted_wisdom",
      ...
      description: "Increases the chance of finding rare gathering points.",
      effects: [
        { level: 1, effect: "3 Pieces Unlock: Forager's Luck" }
      ]
    },
    {
      id: "doshagumas_might",
      ...
      maxLevel: 2,
      description: "Temporarily increases attack after a successful Power Clash or Offset attack.",
      effects: [
        { level: 1, effect: "2 Pieces: Temporarily grants attack +10 after a successful Power Clash or Offset attack" },
        { level: 2, effect: "4 Pieces: Temporarily grants attack +25 after a successful Power Clash or Offset attack" }
      ]
    },
    {
      id: "rathalos_flare",
      ...
      description: "Chance to deal additional Fire Damage after landing an attack.",
      effects: [
        { level: 1, effect: "2 Pieces: Chance to deal additional fire damage after landing an attack." },
        { level: 2, effect: "4 Pieces: Increases additional fire damage after landing an attack." }
      ]
    },
    {
      ...
      effects: [
        ...
        { level: 2, effect: "4 Pieces: Grants an additional long Stamina Gauge." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Reduces the damage you take by 5% when your health is full." },
        { level: 2, effect: "4 Pieces: Reduces the damage you take by 10% when your health is full." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Using the To Victory! gesture moderately increases attack temporarily to nearby allies. Greatly effects Palicoes and Support Hunters." },
        { level: 2, effect: "4 Pieces: Using the To Victory! gesture increases attack temporarily to nearby allies. Greatly effects Palicoes and Support Hunters." }
      ]
    },
    {
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Extends the duration of the Burst skill and grants attack +3 while Burst is active." },
        { level: 2, effect: "4 Pieces: Further extends the duration of the Burst skill and grants attack +10 while Burst is active." }
      ]
    },
    {
      id: "xu_wus_vigor",
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Temporarily grants attack +15 after eating items such as well-done steak." },
        { level: 2, effect: "4 Pieces: Temporarily grants attack +25 after eating items such as well-done steak." }
      ]
    },
    {
      id: "uth_dunas_cover",
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Increases defense temporarily when using a specialized tool." },
        { level: 2, effect: "4 Pieces: Greatly increases defense and resistance temporarily when using a specialized tool." }
      ]
    },
    {
      id: "rey_daus_voltage",
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Moderately extends the activation time of the Latent Power skill." },
        { level: 2, effect: "4 Pieces: Extends the activation time of the Latent Power skill." }
      ]
    },
    {
      id: "nu_udras_mutiny",
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Deals moderate additional damage while the Resentment skill is active." },
        { level: 2, effect: "4 Pieces: Deals additional damage while the Resentment skill is active." }
      ]
    },
    {
      ...
      type: "Set Bonus Skill",
      maxLevel: 2,
      description: "Increases attack after recovering from certain status effects.",
      effects: [
        { level: 1, effect: "2 Pieces: Increases attack after recovering from webbed status, frostblight, being pinned, or a Power Clash." },
        { level: 2, effect: "4 Pieces: Greatly increases attack after recovering from webbed status, frostblight, being pinned, or a Power Clash." }
      ]
    },
    {
      ...
      description: "Infects you with Frenzy when against Large Monsters.",
      effects: [
        { level: 1, effect: "2 Pieces: Infects you with Frenzy when against large monsters." },
        { level: 2, effect: "4 Pieces: Infects you with Frenzy and raises attack when against large monsters. Attack power increases upon recovery." }
      ]
    },
    {
      ...
      description: "Restores health when destroying a wound on a Large Monster.",
      effects: [
        { level: 1, effect: "2 Pieces: Restores a moderate amount of health when destroying a wound on a large monster." },
        { level: 2, effect: "4 Pieces: Restores health when destroying a wound on a large monster." }
      ]
    },
    {
      id: "arkvelds_hunger",
      ...
      effects: [
        { level: 1, effect: "2 Pieces: Regenerates a small amount of your health as you continually attack a monster. Recovery varies by weapon." },
        { level: 2, effect: "4 Pieces: Regenerates your health as you continually attack a monster. Recovery varies by weapon." }
      ]
    }
  ];